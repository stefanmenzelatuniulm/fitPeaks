...
rf_center_ppm = 4.7; %Center of the RF pulse (ppm) %IST SCHON RELATIV ZU TMS
bw = 2000; %Bandwidth of the RF pulse (Hz)
chemicalSpecies = "Eisdosen Phantom"; %Name(s) of the chemical species in the spectrum
...
floorOffset = 0.015;
path = "C:\Users\menze\Desktop\Matlab\IDEAL\ME bssfp data\2024_11_11\Reconstructed\31"; %Path to data
